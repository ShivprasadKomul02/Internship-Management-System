...
<body>
    ...
    <nav id="nav1" class="navbar navbar-expand-md sticky-top">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav nav-fill w-100 me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="student-dash.php"
              >Dashboard
            </a>
          </li>
          
          <li class="nav-item">
            <a class="nav-link" href="applyInternship.php">Apply Here</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="appliedInternship.php">Applied Internships</a>
          </li class="nav-item">
          <li class="nav-item">
    ...
    <div class="container" py-5>
      <div class="row" mt-4>
        ...
        <?php
        include 'dbcon.php';
        $query = "SELECT * FROM INTERNSHIPINFO";
        ...
        $checkresult=mysqli_num_rows($result)>0;
          ...
          <div class="card">
            <div class="card-body">
               <form action="appliedinfo.php" method="post">
              <h4 class="card-title"> <?php echo $row['companyname'];?></h4>

              <h6 class="card-title"><b>Role    :</b> <?php echo  $row['jobname'];?></h6>
              <h6 class="card-title"><b>Location:</b><?php echo  $row['location'];?></h6>
              <h6 class="card-title"><b>Duration:</b><?php echo $row['duration']." ";?>Month</h6>
              <h6 class="card-title"><b>Stipend :</b><?php echo $row['stipend']; ?>/Month</h6>
              <h6 class="card-title"><b>CGPA    :</b><?php echo $row['cgpa'];?> or above</h6>
              <h6 class="card-title"><b>Passing Yr:</b><?php echo $row['passingyear'];?></h6>

              <h6 class="card-title"><b>LastDate:</b><?php echo "".date("d-m-Y h:i a", strtotime($row['lastdate']));?></h6>
              <br><button class="btn btn-success" type="submit"><b>Apply now</b></button></form>
            </div>
          </div>
        </div>
          ...
          {
            echo "<script>alert('No Internship Found');</script>";
          }
