  ...
  <body>
    ...
    <div class="container-fluid login-section">
      ...
      <div id="sign-up" >
          ...
          <div class="form-floating">
            <input
             ...
             id="enrollment"
              ...
              placeholder="xyz"
            />
            <label for="floatingPassword">PICT Student Id</label>
          </div>
          <div class="form-floating">
            <input
              type="integer"
        ...
        <div class="form-floating">
   <select class="form-select mb-1" aria-label="Class" name="branch" id="branch">
    ...
    <option value="ENTC">ENTC</option>
        ...
        <div class="form-floating">
   <select class="form-select mb-1" aria-label="Class" name="year" id="year">
    ...
    <option value="BE">BE</option>
        ...
        <label for="floatingPassword">Year</label>
         ...
         <div class="form-floating">
   <select class="form-select mb-1" aria-label="Class" name="division" id="division">
    ...
    <option value="4">4</option>
        ...
        <label for="floatingPassword">Division</label>
 </div>
 <div class="form-floating">
            <input
              type="number"
