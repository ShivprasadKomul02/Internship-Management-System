    ...
    <nav id="nav1" class="navbar navbar-expand-md sticky-top">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav nav-fill w-100 me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="admin-dash.html"
              >Dashboard
            </a>
          </li>
          
          <li class="nav-item">
            <a class="nav-link" href="createInternship.html">Create Here</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="activeInternship.html">Active Internships</a>
          </li class="nav-item">
          <li class="nav-item">
