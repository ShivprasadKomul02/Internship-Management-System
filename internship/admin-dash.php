...
<body>
    ...
    <div class="internships">
        <h2 style="padding-bottom: 3px;">Total Internship Applications</h2>
        <p>320</p>
        <h2 style="padding-bottom: 3px;">Total Companies</h2>
        <p>50</p>
        <h2 style="padding-bottom: 3px;">Selected Candidates</h2>
        <p>35</p>
    </div>
