...
<body>
    ...
    <nav id="nav1" class="navbar navbar-expand-md sticky-top">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav nav-fill w-100 me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="applyintern.php">Apply Here</a>
          </li>
          <li class="nav-item">
            ...
            <a class="nav-link" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
              ...
              <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                <div class="offcanvas-header">
                  ...
                  <button style="margin-right: 0px;" type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                </div>
    ...
    <div class="display-intern">
      <h1>Applied Internships</h1>
      <ol>
        <li><h2>Internship 1</h2></li>
        <li><h2>Internship 2</h2></li>
        <li><h2>Internship 3</h2></li>
        <li><h2>Internship 4</h2></li>
        <li><h2>Internship 5</h2></li>
      </ol>
    </div>
